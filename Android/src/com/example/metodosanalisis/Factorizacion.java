...
public class Factorizacion extends Activity {
	...
	public void calcular(View v){
		...
		if(crout.isChecked() && !doolittle.isChecked() && !cholesky.isChecked()){
			this.factorizacionDirectaCrout(matrix, b, 4);
		}else if(doolittle.isChecked() && !crout.isChecked()&& !cholesky.isChecked()){
			this.factorizacionDirectaDoolittle(matrix, b, 4);
			
		}else if(cholesky.isChecked() && !doolittle.isChecked() && !crout.isChecked()){
			this.factorizacionDirectaCholesky(matrix, b, 4);
		}else{
	...
	public static void factorizacionDirectaCrout(double A[][], double[] b, int n){
